    ...
    return (
      <div class={classNames(displayClass, "graph", "people-graph")}>
          ...
          <button class="people-global-graph-icon" aria-label="인물 그래프 크게 보기">
            ...
            >
              <path
                ...
                c1.106,0.86,2.44,1.436,3.898,1.619v10.16c-2.833,0.478-5,2.942-5,5.910c0,3.309,2.691,6,6,6s6-2.691,6-6c0-2.967-2.167-5.431-5-5.91
        ...
        <div class="people-global-graph-outer">
          <div class="people-global-graph-container" data-cfg={JSON.stringify(cfg)}></div>
        </div>
      </div>
    )
  }
